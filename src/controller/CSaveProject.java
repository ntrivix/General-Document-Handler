...
public class CSaveProject extends AbstractAction {
	
	public CSaveProject() {
		super("", GetResource.getIcon("icons/saveproject.png"));
		this.setEnabled(false);

		new AbstractActionTranslator(this, "saveProjectS", "saveProjectLong");
